  ...
  <div id="hd">
    <div class="hd-wrap ue-clear">
      ...
      <div class="login-info ue-clear">
        ...
        <a href="javascript:;" class="msg-txt" style="width:56px">未读邮件</a>
        <a href="javascript:;" class="msg-num"><?php echo ($count); ?></a> </div>
      </div>
      <div class="toolbar ue-clear">
        <a href="<?php echo u('Main/index');?>" class="home-btn" >首页</a>
        ...
        <ul class="nav">
            ...
            <li class="office current">
              <div class="nav-header">
  				<a href="javascript:;" date-src="home.html" class="ue-clear">
  				<span>日常办公</span><i class="icon"></i>
  				</a>
  			</div>
            </li>
          ...
          <li class="agency">
            ...
            <ul class="subnav">
               <li><a href="javascript:;" date-src="<?php echo u('Dept/index');?>">部门列表</a></li>
          ...
          <li class="email">
            ...
            <ul class="subnav">
               <li><a href="javascript:;" date-src="<?php echo u('Email/index');?>">查看邮件</a></li>
               <li><a href="javascript:;" date-src="<?php echo u('Email/add');?>">发邮件</a></li>
           </ul>
          </li>
...
/*function getEmailNum(){
  $.ajax({
    ...
    'success':function(msg){
      ...
      //判断新邮件是否大于老邮件数量,如果大于则进行提示,并将新邮件数量写入到页面提示
      if(new_num > old_num){
...
//使用定时器,调用getEmailNum函数
setInterval('getEmailNum()',20000)*/
</script>
</html>